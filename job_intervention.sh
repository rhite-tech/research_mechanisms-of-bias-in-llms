...
EXPERIMENT_NAME="8b_religion_LR"
...
#python interventions.py --model llama-3-8b --device remote --experiment_name ${EXPERIMENT_NAME}_AddNeg --train_datasets experiment_intra_religion_stereoset --val_dataset experiment_inter_religion_stereoset --probe LRProbe --intervention add --subset false
#python interventions.py --model llama-3-8b --device remote --experiment_name ${EXPERIMENT_NAME}_SubPos --train_datasets experiment_intra_religion_stereoset --val_dataset experiment_inter_religion_stereoset --probe LRProbe --intervention subtract --subset true
